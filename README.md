...
Using loyalty card data, a supermarket has collected basic customer attributes (age, gender, annual income, and spending score). To support targeted business and marketing strategies, the company hired a data scientist to segment customers into meaningful groups.
...
Project objective: Segment customers based on spending behavior to support targeted business strategies.

I cleaned and prepared the dataset, then conducted exploratory data analysis (EDA) to understand distributions and key patterns. Finally, I applied the K-Means clustering algorithm to group customers into distinct segments that can inform marketing, retention, and product decisions.
